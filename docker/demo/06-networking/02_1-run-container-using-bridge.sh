...
# IMPORTANT! RUN CONTAINER USING BRIDGE NETWORK
docker run -d --name $DOCKER_CONTAINER -p 6000:5432 --network=$DOCKER_NETWORK -e POSTGRES_PASSWORD=password postgres:13.4
